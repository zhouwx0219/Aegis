...
$ArgsLine = "--workload $Workload --level $Level --tasks $Tasks --workers $Workers --retries $Retries --reasoning-profile $ReasoningProfile --reasoning-scale $ReasoningScale --seed $Seed $PolicyArgs $PolicyModeArgs $OutputArgs"
$Command = "cd $WslRepo && timeout 180s python3 -m agent.cli.atcc_ablation $ArgsLine"
